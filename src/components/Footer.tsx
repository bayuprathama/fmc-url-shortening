function Footer() {
  return (
    <footer className="bg-very-dark-violet text-purple-50  py-14">
      <div className="max-w-1110 mx-auto flex flex-col lg:flex-row lg:items-start items-center gap-10 lg:justify-between">
        <div>
          <a href="#">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start items-center lg:gap-14 gap-10 lg:justify-between">
          <div className="text-center lg:text-left">
            <h4 className="font-bold mb-6">Features</h4>
            <ul className="flex flex-col gap-4 text-grayish-violet">
              <li>
          ...
          <div>
            <ul className="flex gap-6 lg:mt-2">
              <li>
                <a href="#">
